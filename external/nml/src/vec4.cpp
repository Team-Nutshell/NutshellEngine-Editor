...
vec4::vec4(float _x, const vec3& _yzw): x(_x), y(_yzw.x), z(_yzw.y), w(_yzw.z) {}
vec4::vec4(const vec3& _xyz, float _w): x(_xyz.x), y(_xyz.y), z(_xyz.z), w(_w) {}
vec4::vec4(float _x, float _y, const vec2& _zw): x(_x), y(_y), z(_zw.x), w(_zw.y) {}
vec4::vec4(float _x, const vec2& _yz, float _w): x(_x), y(_yz.x), z(_yz.y), w(_w) {}
